...
import { getPendency } from '@/lib/actions/pendency.action';
// import { Pagination } from '@tanstack/react-table';
import { PendencyFilters } from '@/constants/filters';
  ...
  return (
    ...
    justify-between gap-4 overflow-auto rounded-lg sm:flex-row sm:items-center">
      ...
      <LocalSearchbar 
        ...
        placeholder="Search for Divisions or Correspondance or status"
        otherClasses="flex-1"
      />
